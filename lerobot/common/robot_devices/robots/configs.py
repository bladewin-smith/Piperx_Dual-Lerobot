...
class PiperRobotConfig(RobotConfig):
    ...
    leader_arm_left: dict[str, MotorsBusConfig] = field(
        default_factory=lambda: {
            "main": PiperMotorsBusConfig(
                can_name="can_left_master",
                motors={
                    # name: (index, model)
    ...
    leader_arm_right: dict[str, MotorsBusConfig] = field(
        default_factory=lambda: {
            "main": PiperMotorsBusConfig(
                can_name="can_right_mr",
                motors={
                    # name: (index, model)
                    "joint_1": [1, "agilex_piper"],
                    "joint_2": [2, "agilex_piper"],
    ...
    follower_arm_left: dict[str, MotorsBusConfig] = field(
        default_factory=lambda: {
            "slave": PiperMotorsBusConfig(
                can_name="can_left_slave",
                motors={
                    # name: (index, model)
                    "joint_1": [1, "agilex_piper"],
                    "joint_2": [2, "agilex_piper"],
    ...
    follower_arm_right: dict[str, MotorsBusConfig] = field(
        default_factory=lambda: {
            "slave": PiperMotorsBusConfig(
                can_name="can_right_slave",
                motors={
                    # name: (index, model)
                    "joint_1": [1, "agilex_piper"],
                    "joint_2": [2, "agilex_piper"],
    ...
    cameras: dict[str, CameraConfig] = field(
        default_factory=lambda: {
            ...
            "two": OpenCVCameraConfig(2,30,320,240)
            # "three": OpenCVCameraConfig(4,30,320,240)
        }
    )
